...
class Membre implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addIdProduit(Commande $idProduit): self
    {
        if (!$this->id_produit->contains($idProduit)) {
            $this->id_produit->add($idProduit);
            $idProduit->setIdMembre($this);
        }

        return $this;
    }

    public function removeIdProduit(Commande $idProduit): self
    {
        if ($this->id_produit->removeElement($idProduit)) {
            // set the owning side to null (unless already changed)
            if ($idProduit->getIdMembre() === $this) {
                $idProduit->setIdMembre(null);
            }
        }
